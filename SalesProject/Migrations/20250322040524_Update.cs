        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmailConfirmationCode = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SkinEffect = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderDiscounts", x => new { x.OrderId, x.DiscountId });
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "Address", "AvatarUrl", "CreatedAt", "DateOfBirth", "Email", "EmailConfirmationCode", "FullName", "GoogleId", "IsActive", "PasswordHash", "Phone", "Role", "UpdatedAt" },
                values: new object[,]
                {
                    { new Guid("0f5f2ffb-9852-4195-8f4d-be03a4f949bc"), null, null, new DateTime(2024, 3, 13, 0, 0, 0, 0, DateTimeKind.Utc), null, "customer@example.com", null, "Customer", null, true, "vzdjODqvQwaYhdsgs4ZjHG1di4SB3yomdp6d5f4vnII=", null, "Customer", new DateTime(2024, 3, 13, 0, 0, 0, 0, DateTimeKind.Utc) },
                    { new Guid("6c083302-a160-448a-b912-c9cefb3fef3e"), null, null, new DateTime(2024, 3, 13, 0, 0, 0, 0, DateTimeKind.Utc), null, "admin@example.com", null, "Admin", null, true, "wcIksDzZvHtqhtd/XazkAZF2bEhc1V3EjK+ayHMzXW8=", null, "Admin", new DateTime(2024, 3, 13, 0, 0, 0, 0, DateTimeKind.Utc) }
                });
